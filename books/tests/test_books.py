from books.requests.books import get_books
from books.requests.books import get_book

class TestBooks:
    def test_books_200(self):
        assert get_books().status_code == 200,'status code is not ok'
